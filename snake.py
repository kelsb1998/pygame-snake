...
Snake game.
Authors:
<Mikaela Ballard & Robert Thorton>
'''
...
COLOR_BACKGROUND = (159, 55, 150)  # rgb color for white
# This is the color of the snake's head. 
COLOR_SNAKE_HEAD = (24, 158, 73)      # rgb color for red
# This is the color of the rest of the snake.
COLOR_SNAKE = (234, 35, 99)           # rgb color for green
# This is the color for the snake's food.
COLOR_FOOD = (251, 162, 46)          # rgb color for orange
# This is the color for the game over text.
COLOR_GAME_OVER_TEXT = (107, 196, 154)    # rgb color for black
...
def snake_ran_out_of_bounds(snake):
    ...
    """
    if snake[0][0] > 29 or snake[0][0] < 0:
        return True
    elif snake[0][1] > 29 or snake [0][1] < 0:
        return True
    return False
...
def get_game_over_text(score):
    ...
    """
    return 'Game Over. Score: ' + str(int(score))
